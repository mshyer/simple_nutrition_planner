...
CREATE TABLE meal_plans (
  id integer GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
  image_url text DEFAULT '/Users/michaelshyer/launchschool/omnomnom_project/public/Images/default.png',
...
VALUES  ('banana cream pie', 'https://brokenovenbaking.com/wp-content/uploads/2020/12/banana-cream-pie-7.jpg', 1,
         'This is how you make barbecue sauce: First you make the sauce. Then you make the SAWZ'),
...
FROM '/Users/michaelshyer/launchschool/omnomnom_project/nutrition_more_data.csv'
DELIMITER ','
CSV HEADER;
